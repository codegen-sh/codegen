...
from graph_sitter.extensions.tools.view_file import ViewFileObservation, add_line_numbers, view_file
...
from graph_sitter.extensions.tools.list_directory import ListDirectoryObservation, list_directory
...
from graph_sitter.extensions.tools.codegen_sdk_codebase import get_codegen_sdk_codebase

# Import document functions
from graph_sitter.extensions.tools.document_functions import run as document_functions_run
...
class GraphSitterAnalyzer:
    ...
    def get_file_details(self, filepath: str) -> Dict[str, Any]:
        ...
        try:
            ...
            details = {
                ...
                "summary": summary_str,
                "functions": [
                    self._get_function_summary(f) for f in file_obj.functions
                ],
                "classes": [self._get_class_summary(c) for c in file_obj.classes],
                "imports": [self._get_import_summary(i) for i in file_obj.imports],
                "symbols": [
                    self._get_symbol_summary(s)
                    for s in getattr(file_obj, "symbols", [])
                ],
                "metrics": {
                    "lines_of_code": len(file_obj.source.splitlines())
                    ...
                    "documentation_coverage": self._calculate_file_doc_coverage(
                        file_obj
                    ),
                },
            }
    ...
    def get_function_details(
        self, function_name: str, filepath: Optional[str] = None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            target_symbol = self._resolve_symbol_with_filepath(
                symbols, filepath, Function
            )
            if not target_symbol:
                return {
                    "function_name": function_name,
                    "filepath": filepath,
                    "error": "Function not found at specified path or is not a function.",
                }
            ...
            details = {
                "function_name": function_name,
                "filepath": target_symbol.file.filepath
                ...
                "dependencies": [
                    self._symbol_to_dict(s) for s in reveal_info.dependencies
                ]
                if reveal_info.dependencies
                else [],
                "usages": [self._symbol_to_dict(s) for s in reveal_info.usages]
                if reveal_info.usages
                else [],
                "call_sites": [
                    self._call_site_to_dict(cs) for cs in target_symbol.call_sites
                ],
                "function_calls": [
                    self._function_call_to_dict(fc)
                    for fc in target_symbol.function_calls
                ],
                "complexity_metrics": self._calculate_function_complexity_metrics(
                    target_symbol
                ),
                "quality_metrics": self._calculate_function_quality_metrics(
                    target_symbol
                ),
            }
            ...
            return {
                "function_name": function_name,
                "error": f"Error retrieving function details: {e}",
            }

    def get_class_details(
        self, class_name: str, filepath: Optional[str] = None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if not target_symbol:
                return {
                    ...
                    "filepath": filepath,
                    "error": "Class not found at specified path or is not a class.",
                }
            ...
            details = {
                ...
                "attributes": [
                    self._get_attribute_summary(a) for a in target_symbol.attributes
                ],
                "superclasses": [
                    self._class_to_dict(sc) for sc in target_symbol.superclasses
                ],
                "subclasses": [
                    self._class_to_dict(sc) for sc in target_symbol.subclasses
                ],
                "dependencies": [
                    self._symbol_to_dict(s) for s in reveal_info.dependencies
                ]
                ...
                "complexity_metrics": self._calculate_class_complexity_metrics(
                    target_symbol
                ),
            }
            ...
            return {
                "class_name": class_name,
                "error": f"Error retrieving class details: {e}",
            }

    def get_symbol_details(
        self, symbol_name: str, filepath: Optional[str] = None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            target_symbol = self._resolve_symbol_with_filepath(
                symbols, filepath, Symbol
            )
            if not target_symbol:
                return {
                    "symbol_name": symbol_name,
                    "filepath": filepath,
                    "error": "Symbol not found at specified path.",
                }
            ...
            return {
                "symbol_name": symbol_name,
                "error": f"Error retrieving symbol details: {e}",
            }
    ...
    def create_blast_radius_visualization(
        self, symbol_name: str, filepath: Optional[str] = None, max_depth: int = 5
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "nodes": [
                    {"id": str(node), "label": str(node), "type": type(node).__name__}
                    for node in G.nodes()
                ],
                "edges": [
    ...
    def create_call_trace_visualization(
        self, function_name: str, filepath: Optional[str] = None, max_depth: int = 10
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            target_function = self._resolve_symbol_with_filepath(
                symbols, filepath, Function
            )
            if not target_function:
                return {
                    "error": f"Function '{function_name}' not found at specified path or is not a function"
                }
    ...
    def create_dependency_trace_visualization(
        self, symbol_name: str, filepath: Optional[str] = None, max_depth: int = 5
    ) -> Dict[str, Any]:
    ...
    def create_method_relationships_visualization(
        self, class_name: str, filepath: Optional[str] = None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if not target_class:
                return {
                    "error": f"Class '{class_name}' not found at specified path or is not a class"
                }
            ...
            return {
                "error": f"Failed to create method relationships visualization: {e}"
            }
    ...
    def reveal_symbol_relationships(
        self,
        symbol_name: str,
    ...
    def get_symbol_info_detailed(
        self, symbol: Symbol, max_tokens: Optional[int] = None
    ) -> SymbolInfo:
    ...
    def generate_docstrings_for_undocumented(self) -> Dict[str, Any]:
        ...
        try:
            ...
            undocumented_before = len(
                [
                    f
                    for f in self.codebase.functions
                    if not getattr(f, "docstring", None)
                ]
            )
    ...
    def generate_structured_docs(
        self, head_commit: str = "latest", raise_on_missing_docstring: bool = False
    ) -> Any:
        """Generates structured JSON documentation."""
        return generate_docs_json(
            self.codebase, head_commit, raise_on_missing_docstring
        )

    def generate_mdx_documentation(
        self, target_classes: Optional[List[str]] = None, output_dir: str = "docs"
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if target_classes:
                classes_to_document = [
                    ...
                    if cls_doc.title in target_classes
                ]
            else:
            ...
            return {
                "status": "error",
                "error": f"Failed to generate MDX documentation: {e}",
            }
    ...
    def find_dead_code(self) -> Dict[str, Any]:
        ...
        for func in self.codebase.functions:
            if (
                func not in visited
                and not self._is_test_function(func)
                and not self._is_special_function(func)
            ):
                ...
                dead_code["detailed_items"].append(
                    {
                        ...
                        "loc": len(func.source.splitlines())
                ...
                dead_code["detailed_items"].append(
                    {
                        ...
                        "name": cls.name,
                        "file": cls.filepath,
                        "line": cls.start_point.line + 1
                        if hasattr(cls, "start_point")
                        else 0,
                        "reason": "No usage found from entry points",
                        "confidence": 0.7,
    ...
    def run_bash_command(
        self, command: str, is_background: bool = False
    ) -> RunBashCommandObservation:
    ...
    def analyze_function_complexity(
        ...
        try:
            ...
            return {
                "function_name": function_name,
                "filepath": target_function.file.filepath
                if target_function.file
                else "N/A",
                ...
                "return_statements_count": len(
                    getattr(target_function, "return_statements", [])
                ),
                "function_calls_count": len(target_function.function_calls),
                "lines_of_code": len(target_function.source.splitlines())
                if hasattr(target_function, "source")
                else 0,
                "maintainability_score": self._calculate_function_maintainability(
                    target_function
                ),
            }
        except Exception as e:
            return {
                "function_name": function_name,
                "error": f"Error analyzing function complexity: {e}",
            }
    ...
    def analyze_class_structure(
        ...
        try:
                ...
                methods_analysis.append(
                    {
                        ...
                        "lines_of_code": len(method.source.splitlines())
                ...
                attributes_analysis.append(
                    {
                        ...
                        "has_type_annotation": hasattr(attr, "type")
                        and attr.type is not None,
                        "usages_count": len(attr.usages)
                        if hasattr(attr, "usages")
                        else 0,
                    }
                )
            ...
            return {
                ...
                "complexity_score": sum(m["complexity"] for m in methods_analysis)
                / max(1, len(methods_analysis)),
                "public_methods_ratio": len(
                    [m for m in methods_analysis if m["is_public"]]
                )
                / max(1, len(methods_analysis)),
                "documented_methods_ratio": len(
                    [m for m in methods_analysis if m["has_docstring"]]
                )
                / max(1, len(methods_analysis)),
            ...
            return {
                "class_name": class_name,
                "error": f"Error analyzing class structure: {e}",
            }
    ...
    def analyze_import_relationships(self, filepath: str) -> Dict[str, Any]:
        ...
        try:
                ...
                imports_analysis.append(
                    {
                        ...
                        "is_external": isinstance(
                            getattr(imp, "resolved_symbol", None), ExternalModule
                        ),
                        "usages_count": len(imp.usages)
                        if hasattr(imp, "usages")
                        else 0,
                        "is_unused": len(imp.usages) == 0
                        if hasattr(imp, "usages")
                        else True,
                        "line": imp.start_point.line + 1
                        if hasattr(imp, "start_point")
            ...
            return {
                ...
                "external_imports_count": len(
                    [i for i in imports_analysis if i["is_external"]]
                ),
                "unused_imports_count": len(
                    [i for i in imports_analysis if i["is_unused"]]
                ),
                "unresolved_imports_count": len(
                    [i for i in imports_analysis if not i["resolved"]]
                ),
            ...
            return {
                "filepath": filepath,
                "error": f"Error analyzing import relationships: {e}",
            }
    ...
    def _resolve_symbol_with_filepath(
        self, symbols: List[Symbol], filepath: Optional[str], expected_type: type
    ) -> Optional[Symbol]:
        ...
        if filepath:
            for s in symbols:
                if (
                    s.file
                    and s.file.filepath == filepath
                    and isinstance(s, expected_type)
                ):
                    return s
    ...
    def _identify_entrypoints(self) -> Dict[str, List[Dict[str, Any]]]:
        ...
        entrypoints = {"functions": [], "classes": [], "files": []}
        ...
        for file_obj in self.codebase.files:
            if self._is_entrypoint_file(file_obj):
                entrypoints["files"].append(
                    {"name": file_obj.name, "path": file_obj.filepath, "type": "file"}
                )
    ...
    def _get_complexity_overview(self) -> Dict[str, Any]:
        ...
        complexities = [
            self._calculate_function_complexity(f) for f in self.codebase.functions
        ]
        if not complexities:
    ...
    def _call_site_to_dict(self, call_site) -> Dict[str, Any]:
        ...
        return {
            ...
            "file": getattr(call_site, "file", {}).get("filepath", "unknown")
            if hasattr(call_site, "file")
            else "unknown",
            "line": getattr(call_site, "start_point", {}).get("line", 0)
            if hasattr(call_site, "start_point")
            else 0,
        }
    ...
    def _function_call_to_dict(self, function_call) -> Dict[str, Any]:
        ...
        return {
            ...
            "line": getattr(function_call, "start_point", {}).get("line", 0)
            if hasattr(function_call, "start_point")
            else 0,
        }
    ...
    def _calculate_class_complexity_metrics(self, cls: Class) -> Dict[str, Any]:
        ...
        method_complexities = [
            self._calculate_cyclomatic_complexity(m) for m in cls.methods
        ]
        return {
            "average_method_complexity": sum(method_complexities)
            / max(1, len(method_complexities)),
            "max_method_complexity": max(method_complexities)
    ...
    def _calculate_inheritance_metrics(self, cls: Class) -> Dict[str, Any]:
        ...
        return {
            ...
            "coupling_between_objects": len(
                [dep for dep in cls.dependencies if isinstance(dep, Class)]
            ),
            "response_for_class": len(cls.methods)
            + len([m for sc in cls.superclasses for m in sc.methods]),
        }
    ...
    def _build_blast_radius_graph(
        ...
        graph.add_node(
            symbol, name=symbol.name, type=type(symbol).__name__, depth=depth
        )
        ...
        for usage in symbol.usages:
            if hasattr(usage, "usage_symbol"):
                ...
                if depth + 1 < max_depth:
                    self._build_blast_radius_graph(
                        graph, affected_symbol, max_depth, depth + 1
                    )

    def _build_call_trace_graph(
        self, graph: nx.DiGraph, func: Function, max_depth: int, depth: int = 0
    ):
        ...
        for call in func.function_calls:
            if hasattr(call, "function_definition") and call.function_definition:
                ...
                if (
                    not isinstance(called_func, ExternalModule)
                    and called_func not in graph.nodes
                ):
                    graph.add_node(
                        called_func,
                    ...
                    if depth + 1 < max_depth:
                        self._build_call_trace_graph(
                            graph, called_func, max_depth, depth + 1
                        )

    def _build_dependency_trace_graph(
        self, graph: nx.DiGraph, symbol: Symbol, max_depth: int, depth: int = 0
    ):
        ...
        for dep in symbol.dependencies:
            ...
            if (
                isinstance(dep, Symbol)
                and not isinstance(dep, ExternalModule)
                and dep not in graph.nodes
            ):
                graph.add_node(
                    dep, name=dep.name, type=type(dep).__name__, depth=depth + 1
                )
    ...
    def _is_entrypoint_function(self, func: Function) -> bool:
        ...
        return (
            ...
            or self._has_entrypoint_decorators(func)
            or self._is_called_from_main_block(func)
        )
    ...
    def _is_entrypoint_class(self, cls: Class) -> bool:
        ...
        return (
            any(pattern in cls.name.lower() for pattern in entrypoint_patterns)
            or self._has_framework_inheritance(cls)
            or self._has_singleton_pattern(cls)
        )
    ...
    def _is_test_function(self, func: Function) -> bool:
        ...
        return (
            ...
            or "test" in func.filepath
            or self._has_test_decorators(func)
        )
    ...
    def _has_entrypoint_decorators(self, func: Function) -> bool:
        ...
        for decorator in func.decorators:
            ...
            if any(
                ...
                for pattern in ["@app.", "@click.", "@typer.", "@fastapi."]
            ):
                return True
        return False
    ...
    def _is_called_from_main_block(self, func: Function) -> bool:
        ...
        for usage in func.usages:
            if hasattr(usage, "parent_statement"):
                ...
                if hasattr(parent, "condition") and "__name__" in getattr(
    ...
    def _calculate_file_complexity(self, file_obj: SourceFile) -> float:
        ...
        try:
            ...
            function_complexities = [
                self._calculate_cyclomatic_complexity(func)
    ...
    def _get_symbol_summary(self, symbol: Symbol) -> Dict[str, Any]:
        ...
        return {
            ...
            "line": symbol.start_point.line + 1
    ...
    def _get_method_summary(self, method: Function) -> Dict[str, Any]:
        ...
        return {
            "name": method.name,
            "line": method.start_point.line + 1
            if hasattr(method, "start_point")
            else 0,
            "complexity": self._calculate_cyclomatic_complexity(method),
            "parameters_count": len(method.parameters),
            "is_public": not method.name.startswith("_"),
    ...
    def _get_symbol_context(self, symbol: Symbol) -> Dict[str, Any]:
        ...
        return {
            "parent_class": symbol.parent_class.name
            if getattr(symbol, "parent_class", None)
            else None,
            "parent_function": symbol.parent_function.name
            if getattr(symbol, "parent_function", None)
            else None,
