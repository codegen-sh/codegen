...
class MarkdownToADFAdapter:
    ...
    def _convert_code_block(self, element: Element) -> ADFCodeBlockNode:
        ...
        node: ADFCodeBlockNode = {
            "type": ADFNodeType.CODE_BLOCK,
            "content": [self._create_text(text_content)]
        }
