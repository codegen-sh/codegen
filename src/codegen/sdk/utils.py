...
def is_minified_js(content):
    ...
    try:
        ...
        is_minified = (
            (avg_line_length > 100)  # Long average line length
            and (semicolon_ratio > 0.5 or has_common_patterns)  # High semicolon ratio or minification patterns
            and (whitespace_ratio < 0.15)  # Low whitespace ratio
            and (not variable_names or avg_var_length < 3)  # Short variable names or no vars
        )
