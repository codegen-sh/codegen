...
from codegen.sdk.extensions.attribution.main import add_attribution_to_symbols, analyze_ai_impact
...
@codegen.sdk.function("analyze-ai-impact")
def run(codebase: Codebase):
    ...
    Run the analysis using the codegen.sdk.cli:
    codegen analyze-ai-impact

    Or from script:
    from codegen.sdk.extensions.attribution.cli import run
    codebase = Codebase....
    run(codebase)
    """
