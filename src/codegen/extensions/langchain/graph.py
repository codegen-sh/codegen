        ...
        def handle_tool_errors(exception):
            ...
            if "validation error" in error_msg.lower():
                ...
                if type_errors:
                    errors_str = "\n- ".join(type_errors)
                    return (
                        f"Error using {tool_name} tool: Parameter type errors:\n- {errors_str}\n\n"
                        f"You provided: {tool_input}\n\n"
                        f"Please try again with the correct parameter types."
                    )
                ...
                if missing_fields:
                    ...
                    return (
                        ...
                        f"You provided: {tool_input}\n{tool_docs}{example}\n"
                        f"Please try again with all required parameters."
                    )
                ...
                if tool:
                    ...
                    return (
                        f"Error: Could not identify the tool you're trying to use.\n\n"
                        f"Available tools:\n{available_tools}\n\n"
                        f"Please use one of the available tools with the correct parameters."
                    )
