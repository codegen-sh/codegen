...
def get_api_client():
    ...
    if not API_CLIENT_AVAILABLE:
        raise RuntimeError("codegen-api-client is not available")
...
def create_agent_run(
    ...
    try:
        ...
        response = agents_api.create_agent_run_v1_organizations_org_id_agent_run_post(
            org_id=org_id,
            create_agent_run_input=agent_input
        )
...
def get_agent_run(
    ...
    try:
        ...
        response = agents_api.get_agent_run_v1_organizations_org_id_agent_run_agent_run_id_get(
            org_id=org_id,
...
def get_users(
    ...
    try:
        ...
        response = users_api.get_users_v1_organizations_org_id_users_get(
            org_id=org_id
        )
...
def get_user(
    ...
    try:
        ...
        response = users_api.get_user_v1_organizations_org_id_users_user_id_get(
            org_id=org_id,
            user_id=user_id
        )
