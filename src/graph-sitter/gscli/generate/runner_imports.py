...
from codegen.sdk.git.utils.file_utils import split_git_path
from codegen.sdk.shared.decorators.docs import DocumentedObject
...
""".strip()
CODEGEN_IMPORTS = """
from codegen.sdk.git.models.codemod_context import CodemodContext
from codegen.sdk.git.models.github_named_user_context import GithubNamedUserContext
from codegen.sdk.git.models.pr_options import PROptions
from codegen.sdk.git.models.pr_part_context import PRPartContext
from codegen.sdk.git.models.pull_request_context import PullRequestContext
"""
