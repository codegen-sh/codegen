...
from codegen.sdk.gscli.generate.runner_imports import _generate_runner_imports
from codegen.sdk.gscli.generate.system_prompt import get_system_prompt
from codegen.sdk.gscli.generate.utils import LanguageType, generate_builtins_file
...
def _generate_codebase_typestubs() -> None:
    ...
    os.system("uv run pyright -p . --createstub codegen.sdk.git")
