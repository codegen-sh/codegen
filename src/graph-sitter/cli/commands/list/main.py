...
from codegen.sdk.cli.rich.codeblocks import format_codeblock, format_command
...
def list_command():
    ...
    if functions:
        ...
        rich.print("\nAdd a function with @codegen.sdk.function decorator:")
        rich.print(format_codeblock("@codegen.sdk.function('label')"))
