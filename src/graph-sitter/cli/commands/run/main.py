...
from codegen.sdk.cli.utils.codemod_manager import CodemodManager
from codegen.sdk.cli.utils.json_schema import validate_json
from codegen.sdk.cli.workspace.decorators import requires_init
from codegen.sdk.cli.workspace.venv_manager import VenvManager
...
def run_command(
    ...
    # Run the codemod
    if daemon:
        from codegen.sdk.cli.commands.run.run_daemon import run_daemon

        run_daemon(session, codemod, diff_preview=diff_preview)
    else:
        from codegen.sdk.cli.commands.run.run_local import run_local
