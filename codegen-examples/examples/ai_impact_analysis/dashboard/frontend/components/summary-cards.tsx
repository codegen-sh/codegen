    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">{stats.ai_percentage.toFixed(1)}% of total commits</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{data.high_impact_symbols.length}</div>
          <p className="text-xs text-muted-foreground">AI-written symbols with high usage</p>
        </CardContent>
      </Card>
    </div>
  )
