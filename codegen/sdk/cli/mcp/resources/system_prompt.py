...
export const metaCode = `from codegen.sdk.core.codebase import Codebase
...
The [codegen.sdk.cli](/cli/about) provides commands to generate `.md` files that can be fed to any AI assistant for more accurate and contextual help.
...
```python
from codegen.sdk.core.codebase import Codebase
from codegen.sdk.configs.models.codebase import CodebaseConfig
from codegen.sdk.configs.models.secrets import SecretsConfig
...
```python
from codegen.sdk.core.codebase import Codebase
from codegen.sdk.git.repo_operator.repo_operator import RepoOperator
from codegen.sdk.git.schemas.repo_config import RepoConfig
...
Graph-sitter enables you to create reusable code transformations using Python functions decorated with `@codegen.sdk.function`. These codemods can be shared, versioned, and run by your team.
...
@codegen.sdk.function("rename-function")
...
1. The `@codegen.sdk.function` decorator that names your codemod
...
@codegen.sdk.function("update-imports")
def run(codebase: Codebase):
...
sidebarTitle: "@codegen.sdk.function"
icon: "at"
iconType: "solid"
---
...
To use the `function` decorator, simply annotate your function with `@codegen.sdk.function` and provide a name as an argument.

### Example

```python
@codegen.sdk.function('my-function')
def run(codebase):
    pass
```

In this example, the function `run` is decorated with `@codegen.sdk.function` and given the name `'my-function'`. This name will be used when the function is ran.
...
<Note>
  codegen.sdk.visualizations are powered by [NetworkX](https://networkx.org/) and
