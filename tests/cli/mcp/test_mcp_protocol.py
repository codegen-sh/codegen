...
class TestMCPProtocol:
    ...
    def test_mcp_initialization_sequence(self, mcp_server_process):
        ...
        init_message = {
            ...
            "id": 1,
            "method": "initialize",
            "params": {"protocolVersion": "2024-11-05", "capabilities": {"roots": {"listChanged": True}, "sampling": {}}, "clientInfo": {"name": "test-client", "version": "1.0.0"}},
        }
    ...
    def test_mcp_resource_read_request(self, mcp_server_process):
        ...
        # Read a resource
        read_resource_message = {"jsonrpc": "2.0", "id": 4, "method": "resources/read", "params": {"uri": "system://agent_prompt"}}
    ...
    def test_mcp_tool_call_request(self, mock_get_api_client, mcp_server_process):
        ...
        tool_call_message = {
            ...
            "id": 5,
            "method": "tools/call",
            "params": {"name": "generate_codemod", "arguments": {"title": "test-codemod", "task": "Add logging to functions", "codebase_path": "/tmp/test"}},
        }
    ...
    def test_mcp_invalid_method_request(self, mcp_server_process):
        ...
        # Send invalid method
        invalid_message = {"jsonrpc": "2.0", "id": 6, "method": "invalid/method"}
    ...
    def test_mcp_concurrent_requests(self, mcp_server_process):
        ...
        messages = [
            ...
            {"jsonrpc": "2.0", "id": 4, "method": "resources/read", "params": {"uri": "system://manifest"}},
        ]
    ...
    def test_mcp_server_shutdown_handling(self, mcp_server_process):
        ...
        shutdown_message = {"jsonrpc": "2.0", "id": 99, "method": "shutdown"}
