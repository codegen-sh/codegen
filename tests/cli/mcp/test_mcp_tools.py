...
class TestMCPTools:
    ...
    def test_generate_codemod_tool(self, mock_get_api_client):
        ...
        result = generate_codemod_tool.fn(
            title="test-codemod",
    ...
    def test_create_agent_run_tool_success(self, mock_get_api_client):
        ...
        # Test the tool function
        result = create_agent_run_tool.fn(
            org_id=1,
            prompt="Test prompt",
            repo_name="test-repo",
    ...
    def test_get_organizations_tool_success(self, mock_get_api_client):
        ...
        mock_org1.created_at = datetime.now()
        
        mock_org2 = Mock()
        mock_org2.id = 2
        mock_org2.name = "Test Org 2"
        mock_org2.slug = "test-org-2"
        mock_org2.created_at = datetime.now()
