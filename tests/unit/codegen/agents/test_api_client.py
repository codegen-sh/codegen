...
class TestApiClient:
    ...
    def test_param_serialize(self, api_client):
        ...
        with patch.object(api_client, 'sanitize_for_serialization') as mock_sanitize, \
             patch.object(api_client, 'default_headers', {}):  # Empty the default headers
            ...
            result = api_client.param_serialize(
                method, resource_path, path_params, query_params, 
                header_params, body, None, None, None, None, None
            )
    ...
    def test_response_deserialize(self, api_client):
        ...
        with patch.object(api_client, 'deserialize') as mock_deserialize, \
    ...
    def test_response_deserialize_error(self, api_client):
        ...
        # Mock methods
        with patch.object(api_client, 'deserialize') as mock_deserialize, \
             patch("codegen.agents.client.openapi_client.exceptions.ApiException.from_response") as mock_exception:
