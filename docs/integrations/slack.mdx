...
### Option 1: Install from Slack App Marketplace

<Card
  title="Install from Slack App Marketplace"
  icon="slack"
  href="https://thecodegen.slack.com/marketplace/A05J9AP4QRF-codegen"
>
  Install Codegen directly from the official Slack App Marketplace listing.
</Card>

### Option 2: Install via Codegen Dashboard
