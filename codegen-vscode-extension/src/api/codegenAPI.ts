...
export class CodegenAPI {
  ...
  public async askQuestion(question: string, context?: string): Promise<CodegenResponse> {
    try {
  ...
  public async generateCode(prompt: string, language?: string): Promise<CodegenResponse> {
    try {
  ...
  public async explainCode(code: string, language?: string): Promise<CodegenResponse> {
    try {
  ...
  public async improveCode(code: string, language?: string): Promise<CodegenResponse> {
    try {
  ...
  public async fixCode(code: string, error?: string, language?: string): Promise<CodegenResponse> {
    try {
